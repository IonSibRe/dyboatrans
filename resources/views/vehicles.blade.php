<x-layout>
    <header class="veh-header">
        <div class="veh-header-inner">
            <div class="veh-content">
                <h1 class="veh-content-title">Vozový <br> <span>park</span></h1>
                <div class="veh-content-row"></div>
                <p class="veh-content-text">
            ...
            <div class="veh-buses-upper-wrap">
                <div class="veh-buses-upper-text-wrap">
                    ...
                    <p class="veh-buses-upper-text">
                        INFORMACE O AUTOBUSU, SKVĚLÝ, PROSTORNÝ, VELKÝ. INFORMACE O AUTOBUSU, SKVĚLÝ, PROSTORNÝ, VELKÝ.
                        INFORMACE O AUTOBUSU, SKVĚLÝ, PROSTORNÝ, VELKÝ. INFORMACE O AUTOBUSU, SKVĚLÝ, PROSTORNÝ, VELKÝ.
                        INFORMACE O AUTOBUSU, SKVĚLÝ, PROSTORNÝ, VELKÝ. INFORMACE O AUTOBUSU, SKVĚLÝ, PROSTORNÝ, VELKÝ.
                ...
                <div class="veh-buses-upper-img-wrap">
                    <img src="{{" imgs/veh-buses-img.jpg"}}" alt="Vehicles Bus Image" class="veh-buses-upper-img">
                </div>
            </div>
            <div class="veh-buses-lower-wrap">
                ...
                <div class="veh-buses-lower-imgs-wrap">
                    <div class="veh-buses-lower-imgs-inner-wrap">
                        <img src="{{" imgs/vehicles/veh-buses-img.jpg"}}" alt="Vehicle Bus Small Image"
